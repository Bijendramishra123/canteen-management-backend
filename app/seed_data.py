...
if __name__ == "__main__":
    ...
    try:
        ...
        print("=" * 60)
        print("\n🔍 Now run Specmatic tests:")
        print("   docker run --rm -v C:\\Users\\RAVI\\Desktop\\canteen-backend:/work specmatic/specmatic test /work/openapi.json --host host.docker.internal --port 8000")
